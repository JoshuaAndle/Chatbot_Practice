...
class DataBaseManager():
    def __init__(
        ...
        self.embedder_tokenizer = AutoTokenizer.from_pretrained(embedder_name, padding_side='left').to(device)
    ...
    def process_pandas_data(self):
        ...
        if self.dataset_name == "huyen_research_abstracts":
            ...
            datapath = os.path.join(".", "data", self.dataset_name)
    ...
    def process_faiss_data(self):
        ...
        index_path = "./data/{self.dataset_name}.faiss"
    ...
    def process_chroma_data(self):
        ...
        client = chromadb.PersistentClient(path="./data/chromadb_{self.dataset_name}")
    ...
    def prepare_data(self, databases: list[str] = ["pandas", "faiss", "chromadb"]):
        ...
        if "pandas" in databases:
            ...
            self.df.to_parquet("./data/{self.dataset_name}.parquet")
        else:
            assert os.isfile("./data/{self.dataset_name}.parquet"), "Pandas data needs to be prepared prior to setting up other databases"
